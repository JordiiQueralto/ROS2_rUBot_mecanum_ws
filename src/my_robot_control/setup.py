...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_wallfollower2_exec = my_robot_control.my_robot_wallfollower2:main',
            'my_robot_wallfollower_mix_exec = my_robot_control.my_robot_wallfollower_mix:main',
